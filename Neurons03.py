...
class IzhikevichNeuron():
    def __init__(self):
        ...
        self.input_amp = 4               # input amplitude
...
class IAFneuron():
    ...
    def DoTimeStep(self,t):
        self.Vm[t] = self.Vm[t-1] + (self.gLeak*(self.Eleak-self.Vm[t-1]))+(self.AHP[t-1]*(self.EK-self.Vm[t-1]))+(self.KCa[t-1]*(self.EK-self.Vm[t-1]))
