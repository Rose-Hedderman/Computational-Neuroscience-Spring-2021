...
#myNeuron = mySimClass()   # Create an instance of your class here
myNeuron = Project01.Project01Neuron()
...
def runSim():
    ...
    if mainWin.simToRun == 1: 
        print('your code would be running now')
        #while keepgoing:
            #call your runSim or DoTimeStep from here
